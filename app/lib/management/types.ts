...
export interface SingleTransactionFormProps
  extends EntityManagementFormsProps {
  submissionId: string;
...
export type EntityManagementFilter = z.infer<typeof EntityManagementFilterSchema>;

export const PaginatedResultSchema = PaginationSettingsSchema.extend({
  content: z.any().array(),
});
...
export type EntityManagementAction = z.infer<
  typeof EntityManagementActionEnum
>;
